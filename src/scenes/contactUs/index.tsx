...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="contactus" className="pb-23 mx-auto w-5/6 pt-24">
      <motion.div
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/0a2e4d96cc8f993645c89155d6075b64"
            >
              {/* 1 */}
              <input
              ...
              <input
                ...
                {...register("email", {
                  required: true,
                  pattern: /^[A-Z0-9._%+-] +@[A-Z0-9.-]+\.[A-Z]{2,}$/i, //check email validation
                })} //react-hook form
              />
              {/* error validations */}
              {errors.email && (
